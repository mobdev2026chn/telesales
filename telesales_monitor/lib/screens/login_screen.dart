...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _showMobileNumberVerificationSheet(BuildContext context, TeleProvider tele, Map<String, dynamic>? user) {
    ...
    showModalBottomSheet(
      ...
      if (!tele.isLoggedIn) tele.cancelPendingPhoneLink();
    });
  }

  void _showForgotPasswordSheet(BuildContext context) {
    // Passwords are reset by an admin / manager on the web portal; the app has no reset flow.
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("FORGOT PASSWORD?", style: AppTheme.headline(size: 16, color: AppTheme.ink900)),
                IconButton(
            ...
            const SizedBox(height: 6),
            Text(
              "Ask your manager or admin to reset your password from the AskEVA web portal, then sign in with the new password.",
